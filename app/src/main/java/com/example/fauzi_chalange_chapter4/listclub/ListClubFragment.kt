...
import com.example.fauzi_chalange_chapter4.databinding.FragmentListBinding
import com.example.fauzi_chalange_chapter4.listclub.adapter.ClubAdapter
...
import com.example.fauzi_chalange_chapter4.R
...
class ListClubFragment : Fragment(), ClubAdapterListener {
    ...
    private val listClubFragmentViewModel by viewModels<ListClubFragmentViewModel>(
        factoryProducer = {
            ListClubFragmentViewModel.provideFactory(
                owner = this,
